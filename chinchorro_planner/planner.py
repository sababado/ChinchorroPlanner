...
class ChinchorroCanvas:
    ...
    def draw_chinchorro(self, gradient_range, gradient_pos, gradient_str):
        padding = 2
        ...
        top_gradient_str_range_number: float = gradient_formula(str_in_range + 1)
